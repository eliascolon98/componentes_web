    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data == 1) {
                ...
                alert("Este enlace ya caducó, por favor vuelve a hacer el proceso.");
                redirect();
            } else {
                alert("Error al cambiar contraseña.");
                redirect();
...
/** Eventos para recuperar contraseña */
$(".btn-recuperar").click(function(){
    $(".panel_recuperar_pass").removeClass("dis-n");
    $(".panel_login").addClass("dis-n");
})