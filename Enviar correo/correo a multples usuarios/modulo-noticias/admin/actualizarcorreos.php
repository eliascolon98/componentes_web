...
<div id="wrapper">
     <!-- Navigation -->
            ...
            $selected_cat = false;
             while($registro = mysqli_fetch_array($res)){
                ...
                for($i=0; $i < count($mail_list);$i++){
                      if($mail_list[$i]->email == $mail){
                        $selected_item = $mail_list[$i];
        ...
        ?>
                <form class="form-horizontal" method="post" action="updateCorreos.php" enctype="multipart/form-data" >
                    <input name="catg" type="hidden" value="<?php echo $selected_cat; ?>">
                    <div class="form-group">
                        <label for="focusedinput" class="col-sm-2 control-label">Nombre</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="nombre" id="nombre" value="<?php echo $selected_item->nombre; ?>"  required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="disabledinput" class="col-sm-2 control-label">Correo</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control1" name="email" id="email" value="<?php echo $selected_item->email; ?>" required>
                            <input type="hidden" name="emailold" id="emailold" value="<?php echo $selected_item->email; ?>" >
                        </div>
                    </div>
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button class="btn-success btn">Actualizar Correo</button>
